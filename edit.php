...
if (isset($_POST['submit'])) {
    ...
    $merk = $_POST['merk_barang'];// Mengambil nama barang dari input form
...
<body>
    ...
    <form action="edit.php?id=<?php echo $_GET['id'] ?>" method="post">
        ...
        ?>
                ...
                <input for="text" id="merk_barang" name="merk_barang" value="<?php echo $data['merk_barang'] ?>" required><br><br>
